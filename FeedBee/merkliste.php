                ...
                <div class="col-md">
                    <div class="card card-body mb-2">
                        <div class="media align-items-center align-items-lg-start text-center text-lg-left flex-column flex-lg-row">
                            <div class="mr-2 mb-3 mb-lg-0"><img src="img/Thymian2.jpg" width="180" height="150" alt=""> 
                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-3">
                                                <div class="mt-3">
                                                    ...
                                                    <p class="mb-0 text-muted"><?php print_r($row[15]);?></p>
                                                </div>
                                            </div>
                                            <div class="col-3">
                                                <div class="mt-3">
                                                    <img src="img/sonne.png" style="height: 30px; width: 30px;"/>
                                                    <p class="mb-0 text-muted"><?php print_r($row[16]);?></p>
                                                </div>
                                            </div>
                                            <div class="col-3">
                                                <div class="mt-3">
