                                ...
                                <div class="row">
                                    ...
                                    <div class="card-body d-flex justify-content-center mb-2">
                                        <div class="media align-items-center align-items-lg-start text-center text-lg-left flex-column flex-lg-row">
                                            <div class="mr-2 mb-3 mb-lg-0"> <img src="img/Thymian2.jpg" width="100" height="100" alt=""> </div>
                                            <h6 class="media-title font-weight-semibold mt-5"> Thymian <a href="#" data-abc="true"><i class="material-icons" style="vertical-align: middle;">bookmark_border</i></i></a> </h6> <br>
                                    </div>
                                </div>   
                    </div>   
