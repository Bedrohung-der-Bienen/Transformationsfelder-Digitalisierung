...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 08. Okt 2021 um 11:27
...
(1, 'Die Pflanze ist sehr schön.', '2021-10-08 09:21:19', 11, 9);
...
CREATE TABLE `pflanze` (
  ...
  `Jahreszeit` varchar(50) NOT NULL,
...
--
ALTER TABLE `kommentare`
  MODIFY `idKommentare` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;
