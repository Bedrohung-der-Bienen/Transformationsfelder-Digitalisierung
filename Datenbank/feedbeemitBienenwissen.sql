...
--
-- Host: localhost
-- Erstellungszeit: 06. Okt 2021 um 21:59
...
(27, 'vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv\r\n', '2021-09-30 17:10:47', 10, 2);
...
(10, 'ttvvt', 'Merve', 'Tanriverdi', 'oho', 'mervetv@hotmail.de'),
...
--
-- Indizes für die Tabelle `bienenwissen`
--
ALTER TABLE `bienenwissen`
  ADD PRIMARY KEY (`idbienenwissen`);
...
--
-- AUTO_INCREMENT für Tabelle `bienenwissen`
--
ALTER TABLE `bienenwissen`
  MODIFY `idbienenwissen` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT für Tabelle `kommentare`
--
ALTER TABLE `kommentare`
  MODIFY `idKommentare` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
